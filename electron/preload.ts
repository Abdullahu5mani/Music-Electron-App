...
// Remove the exposed raw ipcRenderer for security
// The typed electronAPI provides all needed functionality with proper channel restrictions
// contextBridge.exposeInMainWorld('ipcRenderer', { ... }) - REMOVED for security
