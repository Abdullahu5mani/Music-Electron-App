...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-DU0IzmSG.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-OSLkKf6s.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-BqojGAfj.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-phCLvAMW.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-zmXIwsE2.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BnLQYgUC.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-DGrTfgaB.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-J9V_l943.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-C5zY2VJs.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-DTs9yqRf.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-3-b6MLIU.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-CH4X_Fmt.js")).WaveParser;
  }
};
...
function getStoredMusicFolder() {
  try {
    const configPath = getConfigPath();
    if (fs$1.existsSync(configPath)) {
      const data = fs$1.readFileSync(configPath, "utf-8");
      const config = JSON.parse(data);
      return config.musicFolderPath || null;
    }
  } catch (error) {
...
function registerIpcHandlers() {
  ...
  ipcMain.handle("get-stored-music-folder", async () => {
    return getStoredMusicFolder();
  });
  ipcMain.handle("save-music-folder", async (_event, folderPath) => {
    saveMusicFolder(folderPath);
    return true;
  });
  ipcMain.handle("clear-music-folder", async () => {
    clearMusicFolder();
    return true;
  });
