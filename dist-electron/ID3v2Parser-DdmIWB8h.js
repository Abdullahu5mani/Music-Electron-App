import { O as W, c as U, e as h, P as f, Q as v, b as M, R as D, V as C, A as O, m as j, U as w, H as z, l as T, L as X, W as H, d as P, X as R, G as S, C as B } from "./main-D7ryyLE7.js";
    ...
    switch ($(`Parsing tag type=${a}, encoding=${i}, bom=${l}`), a !== "TXXX" && a[0] === "T" ? "T*" : a) {
      ...
      case "APIC":
        if (t) {
          ...
          r.format = g.fixPictureMimeType(r.format), r.type = O[e[s]], s += 1, c = f(e, s, n, i), r.description = h(e.subarray(s, c), i), s = c + L, r.data = e.subarray(s, n), d = r;
        }
        break;
      case "CNT":
      case "PCNT":
