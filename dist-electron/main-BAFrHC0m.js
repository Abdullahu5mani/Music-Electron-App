...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-DOuua480.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-CZlYITw0.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-Oirj6XQ0.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BTd9C_Ca.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DeH_z2NY.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-CRqyWkzL.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-et2-cteD.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-CerukNCE.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-CaywJWC1.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-CvUkK9vo.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-tnU2LKAf.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-Dc2EpBGr.js")).WaveParser;
  }
};
...
function registerApiHandlers() {
  ...
  ipcMain.handle("lookup-musicbrainz", async (_event, mbid) => {
    try {
      const { MusicBrainzApi } = await import("./entry-node-C8a-dImS.js");
  ...
  ipcMain.handle("download-image-with-fallback", async (_event, urls, filePath) => {
    let lastError = null;
...
async function getInstalledVersion$1(binaryPath) {
  try {
    const { stdout } = await execFileAsync$1(binaryPath, ["--version"], { timeout: 1e4 });
    return stdout.trim();
  } catch (error) {
...
async function getInstalledVersion(binaryPath) {
  try {
    ...
    const { stdout } = await execFileAsync(binaryPath, ["--version"], { timeout: 1e4 });
...
async function getYtDlpStatus() {
  ...
  const fileExists = fs$1.existsSync(binaryPath);
  let version = null;
...
function cleanupOrphanedEntries() {
  const database = initializeDatabase();
  const rows = database.prepare("SELECT filePath FROM metadata_cache").all();
  let removed = 0;
