import { A as R, U as o, S as w, d as E, j as m, J as v, D as U, m as A, G as g, b as p, n as N, e as I, c as S, F as M } from "./main-C14CSr-v.js";
import { A as x } from "./AbstractID3Parser-nje38Xi2.js";
class l {
  static fromBase64(t) {
...
class u {
   ...
   */
  parseFirstPage(t, e) {
    this.metadata.setFormat("codec", "Vorbis I"), this.metadata.setFormat("hasAudio", !0), h("Parse first page");
    const r = d.get(e, 0);
    if (r.vorbis !== "vorbis")
  ...
  async parseFullPage(t) {
    const e = d.get(t, 0);
    switch (h("Parse full page: type=%s, byteLength=%s", e.packetType, t.byteLength), e.packetType) {
      case 3:
