...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-C0DSyo7p.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-BZlbqSsN.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-CC_q0dJR.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BY2D1P2m.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-C7vwXhbr.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-Cs0bWcN8.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BmChj-83.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-BF287xNe.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-DiCAE3_W.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-COvDvTW4.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-D3aXAqIL.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-jt6JhW5C.js")).WaveParser;
  }
};
...
function registerIpcHandlers() {
  ipcMain.handle("download-image", async (_event, url, filename) => {
    try {
      const assetsPath = path$1.join(process.cwd(), "src", "assets");
      if (!fs$1.existsSync(assetsPath)) {
        fs$1.mkdirSync(assetsPath, { recursive: true });
      }
      const filePath = path$1.join(assetsPath, filename);
      console.log(`Downloading image to: ${filePath}`);
      return new Promise((resolve, reject) => {
        https.get(url, (response) => {
          if (response.statusCode !== 200) {
            response.resume();
            resolve({ success: false, filePath: "", error: `Request failed with status ${response.statusCode}` });
            return;
          }
      ...
      console.error("Error in download-image handler:", error);
