...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-BENhnqPm.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-Brx573SV.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-CiiL6OBL.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-DNkcQUsD.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-Bjk6LWcA.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-DqRbIMjo.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BTE2lLjt.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-5RnP3RVX.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-BAmfNlWQ.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-BhM9QYHZ.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-UPfpdjmI.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-BzMu_I-1.js")).WaveParser;
  }
};
  ...
  ipcMain.handle("download-image", async (_event, url, filePath) => {
    try {
      ...
      if (filePath.startsWith("assets/")) {
        ...
        targetPath = require("path").join(userDataPath, filePath);
        const dir = require("path").dirname(targetPath);
        if (!fs$1.existsSync(dir)) {
          fs$1.mkdirSync(dir, { recursive: true });
        }
      }
      fs$1.writeFileSync(targetPath, Buffer.from(buffer));
