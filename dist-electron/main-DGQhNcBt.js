...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-D1czV2cl.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-ggtypmy7.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-B7kMlCoB.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BBws7731.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-lUg4cCPr.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-6CWiLkck.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-DPHAFPf0.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-Dk5u-UVO.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-ZWySV_Nc.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-CMdAiWjH.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-DRhEdPiE.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-D7T6C-TX.js")).WaveParser;
  }
};
      ...
      YTDlpWrap2.prototype.execPromise = function(ytDlpArguments, options, abortSignal) {
        ...
        var ytDlpPromise = new Promise(function(resolve, reject) {
          ...
          ytDlpProcess = (0, child_process_1.execFile)(_this.binaryPath, ytDlpArguments, options, function(error, stdout, stderr) {
            if (error)
              reject(YTDlpWrap2.createError(error, null, stderr));
            resolve(stdout);
          });
          YTDlpWrap2.bindAbortSignal(abortSignal, ytDlpProcess);
        });
      ...
      YTDlpWrap2.prototype.execStream = function(ytDlpArguments, options, abortSignal) {
        ...
        ytDlpProcess.on("close", function(code) {
          if (code === 0 || ytDlpProcess.killed) {
            ...
            var error = YTDlpWrap2.createError(code, processError, stderrData);
...
function getYtDlpWrap() {
  if (!ytDlpWrap) {
    const binaryPath = app.isPackaged ? path$1.join(
      process.resourcesPath,
      "yt-dlp",
      process.platform === "win32" ? "yt-dlp.exe" : "yt-dlp"
    ) : void 0;
    ytDlpWrap = new distExports.YTDlpWrap(binaryPath);
    if (!app.isPackaged) {
      const userDataPath = app.getPath("userData");
      const binaryDir = path$1.join(userDataPath, "yt-dlp-binaries");
      ytDlpWrap.setBinaryPath(binaryDir);
    }
  }
  return ytDlpWrap;
}
