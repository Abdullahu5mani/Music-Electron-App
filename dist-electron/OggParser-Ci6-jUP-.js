import { b as n, k as C, f as d, S as c, m as F, q as r, K as _, c as p, C as b, a as T, l as u, j as I, F as N, B as E, E as z, d as H } from "./main-D7ryyLE7.js";
import "node:fs/promises";
import { V as w, F as x, B as k, a as m, b as L, c as B } from "./FlacParser-DOAz9jX5.js";
...
class A {
  ...
  get(e, t) {
    return {
      magicSignature: new c(8, "ascii").get(e, t + 0),
      version: n.get(e, t + 8),
...
const $ = {
  len: 80,
  get: (a, e) => ({
    speex: new c(8, "ascii").get(a, e + 0),
    version: _(new c(20, "ascii").get(a, e + 8)),
...
const D = {
  len: 27,
  get: (a, e) => ({
    capturePattern: new c(4, "latin1").get(a, e),
    version: n.get(a, e + 4),
    headerType: {
      continued: u(a, e + 5, 0),
      firstPage: u(a, e + 5, 1),
  ...
  async parsePage(e, t) {
    ...
    if (i("firstPage=%s, lastPage=%s, continued=%s", t.headerType.firstPage, t.headerType.lastPage, t.headerType.continued), t.headerType.firstPage) {
      ...
      switch (g) {
        ...
        case "fishead":
        case "theora":
          i("Set page consumer to Ogg/Theora"), this.pageConsumer = new q(this.metadata, this.options, e);
          break;
        case "FLAC":
          i("Set page consumer to Vorbis"), this.pageConsumer = new G(this.metadata, this.options, e);
          break;
        default:
  ...
  async parse() {
    ...
    try {
      do {
        ...
        if (s || (s = new j(this.metadata, t.streamSerialNumber, this.options), this.streams.set(t.streamSerialNumber, s)), await s.parsePage(this.tokenizer, t), s.pageNumber > 12 && !(this.options.duration && [...this.streams.values()].find((o) => o.pageConsumer?.durationOnLastPage))) {
    ...
    for (const s of this.streams.values())
      s.closed || (this.metadata.addWarning(`End-of-stream reached before reaching last page in Ogg stream serial=${s.streamSerial}`), await s.pageConsumer?.flush()), s.pageConsumer?.calculateDuration(e);
  }
}
export {
