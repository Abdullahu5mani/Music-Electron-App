...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-ChoZFBiH.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-CO4yWuM5.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-BijYSkPi.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-CSTULyi7.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-4YEA-OZo.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BYjGwdXM.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-CDKL5EK6.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-Dkpm0D60.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-NJxUrVnX.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-DsxWRlFv.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-Ci4WIFKf.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-Dl5K000c.js")).WaveParser;
  }
};
  ...
  if (!ytDlpWrap) {
    ...
    if (!fs$1.existsSync(binaryPath)) {
      ...
      if (versionCheck.needsUpdate && versionCheck.installedVersion && versionCheck.latestVersion) {
        ...
        onBinaryProgress?.({
          status: "checking",
          message: `yt-dlp is up to date (${versionCheck.installedVersion})`
        });
      }
    }
