...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-Cg7uzr1k.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-CozOftsg.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-DYtC-MeD.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BddiW-13.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-Bg3vx0S0.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-te6hldf1.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-CPfFA1eY.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-flWAQCE6.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-BYT3y_xY.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-7hfDrEVo.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-J57dCrdo.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-Bk2koMBq.js")).WaveParser;
  }
};
...
function formatMusicMetadata(file) {
  if (!file.metadata) {
    return null;
  }
  const metadataParts = [];
  ...
  if (file.metadata.track && file.metadata.track.no !== null) {
    const trackInfo = file.metadata.track.of ? `${file.metadata.track.no}/${file.metadata.track.of}` : `${file.metadata.track.no}`;
...
async function scanAndLogMusicFiles(directoryPath) {
