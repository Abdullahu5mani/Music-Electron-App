...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-CX11KFkt.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-ETMMsHFf.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-DJr1ptWG.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-DydEdMd4.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-DNaU0pEW.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BUP26kFE.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-kO-WJtGA.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-Buj_TgiU.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-BfKCmDu0.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-V22-7DBq.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-DWKe0DTx.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-iUgoeX7r.js")).WaveParser;
  }
};
...
async function identifyAudioFile(audioFilePath) {
  try {
    const fingerprint = await generateFingerprint(audioFilePath);
    if (!fingerprint) {
...
function registerIpcHandlers() {
  ...
  ipcMain.handle("identify-audio", async (_event, filePath) => {
    try {
      const result = await identifyAudioFile(filePath);
