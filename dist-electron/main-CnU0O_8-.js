import { nativeImage, Tray, BrowserWindow, Menu, app, ipcMain, dialog } from "electron";
  ...
  return Menu.buildFromTemplate([
    ...
    },
    {
      ...
      click: () => {
        const windows2 = BrowserWindow.getAllWindows();
        if (windows2.length > 0) {
          windows2[0].webContents.send("tray-previous");
        }
      }
    },
    {
      ...
      click: () => {
        const windows2 = BrowserWindow.getAllWindows();
        if (windows2.length > 0) {
          windows2[0].webContents.send("tray-next");
        }
      }
    },
    { type: "separator" },
...
function createTray() {
  const iconPath = VITE_DEV_SERVER_URL$1 ? path.join(process.env.APP_ROOT, "src", "assets", "trayIcon.png") : path.join(process.env.APP_ROOT, "dist", "assets", "trayIcon.png");
...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-kBeyDwbi.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-I7izG5Hr.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-Dadu7zaR.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-CtrkdS3d.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CtNdoNC0.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-okAn8tL5.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-DD3dzbfj.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-Cuk0r-Jr.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-WwDOFxu9.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-CzvNalsW.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-Cl1KVI0H.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-BTkfqy7N.js")).WaveParser;
  }
};
