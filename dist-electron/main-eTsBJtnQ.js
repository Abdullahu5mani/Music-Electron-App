...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-DXRm4UmP.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-CFyKmsH9.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-JRTpDvkJ.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-NwrGh_B_.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BfGkw1n5.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-D5E983wL.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-CSDiFjIn.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-C7nTeiS2.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-B6b2N_a2.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-Cij4JMhq.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-wu07YXL0.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-jTWanEb0.js")).WaveParser;
  }
};
    ...
    try {
      ...
      const result = await downloadYouTubeAudio({
        ...
        onTitleReceived: (title) => {
          videoTitle = title;
          event.sender.send("download-title", title);
        }
      });
      console.log("Download result:", result);
      return { ...result, title: videoTitle };
    } catch (error) {
