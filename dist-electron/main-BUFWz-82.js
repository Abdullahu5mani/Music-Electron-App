...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-DmEMNZnN.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-VMD_4Za6.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-DRBWH3qL.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-DWlwQyvs.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-VId-Pvnv.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-DMeo_Igp.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-QTmJe0dT.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-CRsbPT3e.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-Cp0Qyx6l.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-Bpp9Ecpv.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-B49BLVKN.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-BiyXaqVq.js")).WaveParser;
  }
};
...
async function getLatestVersionFromGitHub(repo) {
  try {
    ...
    return new Promise((resolve, reject) => {
      https2.get(`https://api.github.com/repos/${repo}/releases/latest`, {
        headers: { "User-Agent": "music-sync-app" }
      }, (res) => {
        let data = "";
        res.on("data", (chunk) => {
