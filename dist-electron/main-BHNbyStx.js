...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-Be-4fC_r.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-C0gQhurf.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-C3KZupzJ.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-CZH9x0C_.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BlNT2kMy.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-BL8dLf2X.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-BamivYbn.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-BNL6vZ53.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-4S6iAwuJ.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-b1k7ELFb.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-DRdpkcpo.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-Df04qLHB.js")).WaveParser;
  }
};
...
function registerIpcHandlers() {
  ...
  ipcMain.handle("write-metadata", async (_event, filePath, metadata, coverArtUrl) => {
    try {
      const { writeMetadata } = await import("./metadataWriter-D3aEzSA7.js");
      return await writeMetadata(filePath, metadata, coverArtUrl);
    } catch (error) {
      console.error("Error in write-metadata handler:", error);
