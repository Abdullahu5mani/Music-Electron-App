...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-CnwUFFlK.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-BDl_wsON.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-CzgV4hmt.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-BX-nhaEj.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-B2Wqy3uG.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-EAZqX3xN.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-H-xXwcUa.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-BP-WGhrG.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-CY8fcJ4L.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-DT7QfOmD.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-BtQHpl_Y.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-av_wnzMg.js")).WaveParser;
  }
};
...
function registerIpcHandlers() {
  ...
  ipcMain.handle("write-cover-art", async (_event, filePath, imagePath) => {
    try {
      ...
      console.log("Writing picture with size:", imageBuffer.length);
      console.log("Current tags before write:", file.tag());
      file.setPictures([picture]);
      const success = file.save();
      console.log("Save result:", success);
      file.dispose();
      {
        const verifyTaglib = await TagLib.initialize();
        const verifyFile = await verifyTaglib.open(filePath);
        const pics = verifyFile.getPictures();
        console.log("Read back pictures count:", pics.length);
        if (pics.length > 0) {
          console.log("First picture type:", pics[0].type);
          console.log("First picture mime:", pics[0].mimeType);
          console.log("First picture size:", pics[0].data.length);
        }
        verifyFile.dispose();
      }
