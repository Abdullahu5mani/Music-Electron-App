...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-CiGUuuk0.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-Cc4eXnHR.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-T-JslQUt.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-HTCkXOKB.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-BdpVIGN5.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-oDP8kFST.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-yLVCTRHA.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-D8fd-UDJ.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-C_MTCugK.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-Cdn_ulZf.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-DYVkX6J7.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-BiMCInn4.js")).WaveParser;
  }
};
...
async function getFfmpegStatus() {
  const userDataPath = app.getPath("userData");
  const binaryDir = path$1.join(userDataPath, "ffmpeg-binaries");
...
async function getFfprobeStatus() {
  const userDataPath = app.getPath("userData");
  const binaryDir = path$1.join(userDataPath, "ffmpeg-binaries");
...
async function getFpcalcStatus() {
  const userDataPath = app.getPath("userData");
  const binaryDir = path$1.join(userDataPath, "chromaprint-binaries");
...
async function getAllBinaryStatuses() {
  const [ytDlp, ffmpeg, ffprobe, fpcalc] = await Promise.all([
    getYtDlpStatus(),
    getFfmpegStatus(),
    getFfprobeStatus(),
    getFpcalcStatus()
  ]);
  return [ytDlp, ffmpeg, ffprobe, fpcalc];
}
