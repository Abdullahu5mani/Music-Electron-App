...
const mpegParserLoader = {
  ...
  async load() {
    return (await import("./MpegParser-Lbc4lARW.js")).MpegParser;
  }
};
...
const asfParserLoader = {
  ...
  async load() {
    return (await import("./AsfParser-fgjaXQdl.js")).AsfParser;
  }
};
const dsdiffParserLoader = {
  ...
  async load() {
    return (await import("./DsdiffParser-BQKMdIM4.js")).DsdiffParser;
  }
};
const aiffParserLoader = {
  ...
  async load() {
    return (await import("./AiffParser-D-fQbAU0.js")).AIFFParser;
  }
};
const dsfParserLoader = {
  ...
  mimeTypes: ["audio/dsf"],
  async load() {
    return (await import("./DsfParser-CKK_RBbQ.js")).DsfParser;
  }
};
const flacParserLoader = {
  ...
  async load() {
    return (await import("./FlacParser-DkaJ-vqi.js").then((n) => n.d)).FlacParser;
  }
};
const matroskaParserLoader = {
  ...
  async load() {
    return (await import("./MatroskaParser-CtvoCdSp.js")).MatroskaParser;
  }
};
const mp4ParserLoader = {
  ...
  async load() {
    return (await import("./MP4Parser-DG1-Vd1f.js")).MP4Parser;
  }
};
const musepackParserLoader = {
  ...
  async load() {
    return (await import("./MusepackParser-DxWHCfKb.js")).MusepackParser;
  }
};
const oggParserLoader = {
  ...
  async load() {
    return (await import("./OggParser-BzOzcHn_.js")).OggParser;
  }
};
const wavpackParserLoader = {
  ...
  async load() {
    return (await import("./WavPackParser-BwvKGagY.js")).WavPackParser;
  }
};
const riffParserLoader = {
  ...
  async load() {
    return (await import("./WaveParser-J6WWdaQi.js")).WaveParser;
  }
};
...
async function lookupFingerprint(fingerprint, duration) {
  return new Promise((resolve, reject) => {
    ...
    https.get(url, {
      headers: {
        "User-Agent": "music-sync-app/1.0.0"
      }
    }, (res) => {
      let data = "";
      res.on("data", (chunk) => {
      ...
      res.on("end", () => {
        try {
          ...
          reject(new Error(`Failed to parse AcoustID response: ${error}`));
        }
      });
    }).on("error", (error) => {
      reject(new Error(`AcoustID API request failed: ${error.message}`));
    });
  });
}
...
async function identifyAudioFileWithFingerprint(fingerprint, audioFilePath) {
  try {
    ...
    throw new Error(`Failed to identify audio file: ${error instanceof Error ? error.message : "Unknown error"}`);
  }
}
function registerIpcHandlers() {
  ...
  ipcMain.handle("identify-audio", async (_event, filePath, fingerprint) => {
    try {
      const result = await identifyAudioFileWithFingerprint(fingerprint, filePath);
      console.log("AcoustID Response:", JSON.stringify(result, null, 2));
      return {
        success: true,
        data: result
      };
    } catch (error) {
      console.error("AcoustID identification error:", error);
      return {
        success: false,
        error: error instanceof Error ? error.message : "Unknown error"
      };
