import { Q as W, D as U, f as h, R as f, V as v, d as M, W as D, X as C, A as j, m as O, U as w, K as z, n as T, N as X, Y as H, e as P, Z as R, J as S, G as B } from "./main-C14CSr-v.js";
...
class g {
  ...
  readData(e, a, t) {
    ...
    const { encoding: i, bom: l } = W.get(e, 0), n = e.length;
    let s = 0, d = [];
    const N = g.getNullTerminatorLength(i);
    let c;
    switch ($(`Parsing tag type=${a}, encoding=${i}, bom=${l}`), a !== "TXXX" && a[0] === "T" ? "T*" : a) {
      ...
      case "PCST": {
        ...
        switch (a) {
          ...
          case "TCO":
          case "TCON":
            d = this.splitValue(a, r).map((o) => F(o)).reduce((o, p) => o.concat(p), []);
            break;
          case "PCS":
          case "PCST":
      ...
      case "APIC":
        if (t) {
          ...
          r.format = g.fixPictureMimeType(r.format), r.type = j[e[s]], s += 1, c = f(e, s, n, i), r.description = h(e.subarray(s, c), i), s = c + N, r.data = e.subarray(s, n), d = r;
        }
        break;
      case "CNT":
      case "PCNT":
...
class b {
  ...
  static readFrameData(e, a, t, i, l) {
    ...
    switch (t) {
      ...
      case 3:
      case 4:
        return a.flags?.format.unsynchronisation && (e = b.removeUnsyncBytes(e)), a.flags?.format.data_length_indicator && (e = e.subarray(4, e.length)), n.readData(e, a.id, i);
      default:
        throw x(t);
    }
  }
