import { d as UINT8, l as UINT16_LE, j as UINT32_LE, S as StringType, m as makeUnexpectedFileContentError, r as INT32_LE, M as trimRightNull, D as Debug, G as UINT24_BE, c as UINT16_BE, n as getBit, k as UINT64_LE, F as FourCcToken, B as BasicParser, E as EndOfStreamError, e as Uint8ArrayType } from "./main-BIlG6D8B.js";
import "node:fs/promises";
import { V as VorbisStream, F as FlacParser, B as BlockHeader, a as BlockType, b as VorbisPictureToken, c as BlockStreamInfo } from "./FlacParser-Dj-1JOhq.js";
...
const debug$3 = Debug("music-metadata:parser:ogg:speex");
...
const debug$2 = Debug("music-metadata:parser:ogg:theora");
class TheoraStream {
...
const debug$1 = Debug("music-metadata:parser:ogg:theora");
class FlacStream {
  constructor(metadata, options, tokenizer) {
    this.durationOnLastPage = false;
    this.metadata = metadata;
...
const debug = Debug("music-metadata:parser:ogg");
class OggStream {
